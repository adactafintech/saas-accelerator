...
public class ProvisioningApiClientLogger : ILogger
{
    /// <summary>
    /// The logger.
    /// </summary>
    private readonly ILogger<ProvisioningApiService> logger;

    /// <summary>
    /// Initializes a new instance of the <see cref="ProvisioningApiClientLogger"/> class.
    /// </summary>
    public ProvisioningApiClientLogger()
    {
        ...
        this.logger = loggerFactory.CreateLogger<ProvisioningApiService>();
    }
